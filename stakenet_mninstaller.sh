...
COIN_PORT=62583
#Updateable
COIN_GIT='https://github.com/X9Developers/XSN/releases/download/v1.0.16/xsn-1.0.16-x86_64-linux-gnu.tar.gz'
FILE_NAME_TAR='xsn-1.0.16-x86_64-linux-gnu.tar.gz'
FILE_NAME='xsn-1.0.16'
WALLET_VER='1001600'
